//4676 行有改动 目的是easyui的tab 切换scrollTop 发生改变目前应用于后台管理页面
(function($){
...
var tab=$("<li>"+"<a href=\"javascript:;\" onclick=\"$.aogtools.commonScroll('#ritArea')\" class=\"tabs-inner\">"+"<span class=\"tabs-title\"></span>"+"<span class=\"tabs-icon\"></span>"+"</a>"+"</li>");
if(!pp){
pp=$("<div></div>");
}

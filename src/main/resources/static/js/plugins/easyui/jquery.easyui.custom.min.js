...
var _b2=aa[_b1];
if(_b2=="list"){
    var ps = $("<input type='text' value='' style='width:30px;'/>");
    ps.val(_ae.pageSize);
    ps.bind('keypress', function(event) {
        if (event.keyCode == "13"){
            var psize = $(this).val();
            if (psize != "" && /^\d+$/.test(psize)) {
    ...
    $("<td>每页</td>").append(ps).append("条").appendTo(tr);
...
$(_4b2).removeClass("validatebox-readonly").removeAttr("readonly");
    ...
    /*?validatebox 增加onlyview功能*/
    if(opts.onlyview){
        $(_4b2).removeClass("validatebox-onlyview").addClass("validatebox-onlyview");
        $("input:hidden[name='"+$(_4b2).attr('textboxname')+"']").siblings('input:text')
            .removeClass("validatebox-onlyview").addClass("validatebox-onlyview")
            .end().siblings('textarea')
            .removeClass("validatebox-onlyview").addClass("validatebox-onlyview");
    }/*?*/
};
...
t.focus().validatebox("validate");
    ...
    /*-*/if($(_4b7).hasClass('combobox-f')){return $(_4b7).combobox('getValue');}/*-*/
return $(_4b7).val();
...
opts.onDblClickCell.call(_65e,_65f,_660,row[_660]);
    ...
    /*?原dbclick*///opts.onDblClickRow.apply(_65e,_5e5(_65e,[_65f,row]));  /*?*/
    /*?更改dbclick*/opts.onDblClickRow.apply(_65e,_5e5(_65e,[e,_65f,row]));/*?*/
};
function _661(e){
var tr=_64d(e.target);
if(tr){
...
if(opts.onBeforeSortColumn.call(_666,_669.sortName,_669.sortOrder,_669)==false){
return;
}
$.extend(opts,_669);
var dc=_668.dc;
...
opts.onSortColumn.call(_666,opts.sortName,opts.sortOrder, opts);
};
...
if(opts.sortName){
$.extend(_755,{sort:opts.sortName_ || opts.sortName,order:opts.sortOrder});
    /*?排序时需清除高级查询排序数据?*/if(typeof(clearAdvancedQuerySortData) == 'function'){clearAdvancedQuerySortData(_755);} /*?*/
}
...
/*? 行编辑样式*///cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">"+_7cd+"</div></td>");
var _c = opts.enableLineEdit !== true || !opts.rownumbers ? ''
        : (_7cc.__editing ? " datagrid-editingcell-rownumber" : ' datagrid-editcell-rownumber');
    cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber"+_c+"\">"+_7cd+"</div></td>");
    /*?*/
}
...
var xhr = $.ajax({type:opts.method,url:opts.url,data:_7ff,dataType:"json",success:function(data){
    /*?datagrid 数据?*/if(!AjaxSuccess(data)){ return; }
if(data.code != 200){ MsgAlert({ content: data.msg, type: 'error'});}
    if(typeof(data.data) != 'object' ||
        Object.prototype.toString.call(data.data) != "[object Array]"){
        data.total = 0; data.data = [];
    }
data.rows = data.data; data.data = null; /*?*/
_800(data);
},error:function(){
...
var opts=($.data(_841,"propertygrid")||{}).options || undefined;  if(!opts)return;
...
_99f(this);
    ...
    /*?增加下拉onlyview属性*/
    var _4d=$.data(jq[0],"combo").options; var _4d0 =$.data(jq[0],"validatebox") ? $.data(jq[0],"validatebox").options : {};
    if(_4d.onlyview||_4d0.onlyview){
        return jq;
    }/*?*/
return jq.each(function(){
_9ae(this);
...
_aa6(this,q);
}},currentText:"Today",cleanText:"Clean",closeText:"Close",okText:"Ok",buttons:[{text:function(_abb){
...
$(_adf).datetimebox("hidePanel");
    ...
    return $(_989).datetimebox("options").cleanText;

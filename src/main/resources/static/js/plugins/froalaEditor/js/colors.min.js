...
!function (r) {
    ...
    C.extend(C.FE.POPUP_TEMPLATES, {"colors.picker": "[_BUTTONS_][_TEXT_COLORS_][_BACKGROUND_COLORS_][_CUSTOM_COLOR_]"}), C.extend(C.FE.DEFAULTS, {
        ...
        function a(o) {
            var e, r = E.popups.get("colors.picker"), t = C(E.selection.element());
        ...
        return {
            showColorsPopup: function () {
                var o = E.$tb.find('.fr-command[data-cmd="color"]'), e = E.popups.get("colors.picker");
                if (e || (e = function () {
                    ...
                    var b,
                        t = {buttons: e, text_colors: s("text"), background_colors: s("background"), custom_color: r},
                    ...
                    return b = a, E.events.on("popup.tab", function (o) {
                        ...
                        if (C.FE.KEYCODE.TAB == r) {
                            ...
                            if (e.is("span.fr-select-color")) {
                                var s = e.parent().find("span.fr-select-color"), l = s.index(e), c = E.opts.colorsStep,
            ...
            }, hideColorsPopup: e, changeSet: function (o, e) {
                ...
                var o = E.popups.get("colors.picker"), e = o.find(".fr-color-hex-layer input");
                if (e.length) {
                    var r = e.val();
                    "background" == o.find(".fr-selected-tab").attr("data-param1") ? t(r) : l(r)
                }
            }, text: l, back: function () {
        ...
        undo: !1, focus: !1, callback: function (o, e) {

    ...
    function addJqueryFunct() {
        ...
        function parse(ele, key, options) {
            ...
            if (attr === 'html') {
                ...
                /*s*/
                if(ENABLE_BILINGUAL == BILINGUAL.DIRECT && ele.hasClass(ENABLE_BILINGUAL)){
                    var ks = key.split(":");
                    var v1 = $.t(key, optionsToUse);
                    var v2 = $.t( "sec-"+ ks[0] + ":" + ks[1], optionsToUse);
                    var sp = ' ';
                    if(ele.hasClass('i18nline')){
                    }else{
                        sp = '<br/>';
                        ele.css({height: '30px', 'line-height': '15px'});
                    }
                    ele.html(v1 + (v1 == v2 ? '': sp + v2));
                } /*e*/
                else{
